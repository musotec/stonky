package tech.muso.stonky.android.view
 ...
 *
 * Hacks like this are highly sensitive to the change in version numbers.
 * Since constructors and components within the library are subject to change.
 * (as is the case for the [ShapeAppearanceModel] class removing the default constructor
 *  in favor of a builder between versions 1.1 to 1.2)
 */
