...
import tech.muso.stonky.android.databinding.ListItemStockCardViewBinding
...
class StockRecyclerViewAdapter(private val viewClickCallback: ((StockEntity) -> Unit)? = null) : ListAdapter<StockEntity, RecyclerView.ViewHolder>(StockDiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return StockItemViewHolder(
                ListItemStockCardViewBinding.inflate(
                    LayoutInflater.from(parent.context), parent, false))
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val stock = getItem(position)
        (holder as StockItemViewHolder).bind(stock, viewClickCallback)
    }
    ...
    class StockItemViewHolder(
        private val binding: ListItemStockCardViewBinding
    ) : RecyclerView.ViewHolder(binding.root) {

        fun bind(item: StockEntity, viewClickCallback: ((StockEntity) -> Unit)? = null) {
            binding.apply {
 ...
 */
private class StockDiffCallback : DiffUtil.ItemCallback<StockEntity>() {
